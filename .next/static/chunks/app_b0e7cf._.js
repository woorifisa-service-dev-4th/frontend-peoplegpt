(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_b0e7cf._.js", {
...
async function getPost(postId) {
    try {
        const query = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$vercel$2f$postgres$2f$dist$2f$chunk$2d$7IR77QAQ$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["sql"]`
...
function Chat({ onSubmit, isComment, activeMenu, setActiveMenu }) {
    ...
    if (postType === "qna") {
        postType = 1;
    } else if (postType === "codeshare") {
        postType = 2;
    } else if (postType === "daily") {
        postType = 3;
    }
    // TODO: title 저장 로직 추가
    const handleSubmit = ()=>{
        if (content.trim() !== "" && title.trim() !== "") {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPost"])(form);
            setTitle("");
            setContent("");
        }
    };
...
_s(Chat, "c/TflAkp2JPiu/FFtSTGdcvAGN8=");
_c = Chat;
var _c;
...
_s(SideNav, "V8e9uWL0aZcxWbWsGpr6VZQUTDg=");
_c = SideNav;
var _c;
...
//# sourceMappingURL=app_b0e7cf._.js.map